 ...
 */
public class DeshApproved extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_desh_approved, container, false);
    ...
    public static Fragment NewInstance(String typeforListing) {
        ...
        DeshApproved fragment = new DeshApproved();
