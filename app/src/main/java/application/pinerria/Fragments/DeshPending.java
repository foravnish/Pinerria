 ...
 */
public class DeshPending extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_desh_pending, container, false);
    ...
    public static Fragment NewInstance(String typeforListing) {
        ...
        DeshPending fragment = new DeshPending();
