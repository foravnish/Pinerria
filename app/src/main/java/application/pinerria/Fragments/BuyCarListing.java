 ...
 */
public class BuyCarListing extends Fragment {


    public BuyCarListing() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_buy_car_listing, container, false);

        grigView=view.findViewById(R.id.grigView);

        getActivity().setTitle("Buy a Car / Property");
