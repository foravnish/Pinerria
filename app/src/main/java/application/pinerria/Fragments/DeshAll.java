 ...
 */
public class DeshAll extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_desh_all, container, false);
    ...
    public static Fragment NewInstance(String vehicleObject) {
        Bundle args = new Bundle();
        args.putString("fragmentKey", vehicleObject);

        DeshAll fragment = new DeshAll();
