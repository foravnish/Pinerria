 ...
 */
public class BuyOtherListing extends Fragment {


    public BuyOtherListing() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_buy_other_listing, container, false);
        grigView=view.findViewById(R.id.grigView);

        getActivity().setTitle("Buy other than Car/Property");
        ...
        grigView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Log.d("fdsfsdgdfgdfh",DataList.get(i).get("id").toString());
    ...
    class Adapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            Picasso.with(getActivity()).load(DataList.get(i).get("photo").toString())
                    .resize(250, 150).centerCrop().into(catImg);
            return view;
        }
    }
